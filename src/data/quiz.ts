...
export const EVENT_TRAITS: Record<string, number[]> = {
  ...
  "vr-simulation": [4, 4, 2, 5, 2, 4, 3, 2, 1, 0],
  "webmaster": [4, 1, 4, 5, 2, 3, 4, 1, 1, 0],
  "artificial-intelligence": [4, 1, 5, 5, 1, 1, 1, 3, 1, 0],
  "automated-manufacturing-systems": [4, 4, 3, 3, 5, 2, 1, 2, 1, 0],
  "hybrid-racer-xl": [4, 3, 4, 2, 5, 3, 1, 2, 5, 0],
  "interior-design": [3, 2, 3, 1, 3, 5, 2, 2, 1, 0],
  "robotics": [4, 4, 4, 4, 5, 2, 2, 2, 3, 0],
  "stem-mass-media": [3, 2, 3, 1, 1, 3, 5, 3, 1, 0],
  "vlogging": [3, 2, 3, 1, 1, 3, 5, 1, 1, 0],
  "medical-technology": [3, 1, 3, 1, 1, 2, 2, 5, 1, 1],
  "cybersecurity": [3, 1, 2, 5, 3, 1, 1, 4, 1, 0],
  ...
  "battling-bots": [4, 3, 3, 4, 5, 2, 1, 2, 3, 1],
